...
public class ConstNpc {
    ...
    public static final byte SHOP_NEW = 77;

    //----------------------index menu------------------------------------------
    public static final int HOP_QUA_THAN_LINH = 1324;

    public static final int CHE_TAO_HOP_QUA = 346236;
    public static final int CHE_TAO_HOP_QUA_NHE_NHANG = 346237;
    public static final int CHE_TAO_HOP_QUA_CHIN_CHU = 346238;

    public static final int TRONG_HOA_HONG = 346239;
    public static final int TRONG_HOA_HONG_1 = 3462310;
    ...
    public static final int MENU_MTV = 2543765;
    public static final int MENU_OPEN_THOI_VANG = 3465854;
    public static final int MENU_OPEN_HONG_NGOC = 457866;

    //index than vu tru
    public static final int MENU_DI_CHUYEN = 3465853;
    public static final int CONFIRM_CHANGE_PET = 500;
    ...
    public static final int HOC_KY_NANG = 534;
    public static final int SUMMON_BLACK_SHENRON = 535;
    ...
    public static final int SHEN_RON_BI_NGO = 506;
    ...
    public static final int SHEN_RON_BI_NGO_CONFIRM = 31720025;
    
    public static final int SUMMON_SHENRON_EVENT_XUONG = 317200212;
    public static final int SHOW_SHENRON_EVENT_CONFIRM_XUONG = 317200223;
    public static final int SHENRON_EVENT_CONFIRM_XUONG = 317200234;
...
//    public static final byte TAI_XIU_EMPTY = 3;
    ...
    public static final int MENU_OPTION_USE_ITEM1227 = 1227;
    public static final int MENU_OPTION_USE_ITEM1228 = 1228;
    public static final int MENU_OPTION_USE_ITEM1229 = 1229;
    public static final int MENU_TD = 519;
    public static final int MENU_NM = 520;
    public static final int MENU_XD = 521;
    public static final int CHUC_NANG_SKH = 5474;
    ...
    public static final int CHUC_NANG_SU_KIEN_TET = 3552;
    ...
    public static final int MENU_DOI_VPSK_TET = 32566;
    public static final int MENU_DOI_VPSK_2 = 325237;
    public static final int MENU_DOI_VPSK_1 = 325238;

    public static final int BANH_CHUNG = 2566;
    public static final int BANH_TET = 25636;
    ...
    public static final int MENU_SINHLE_BANH_CHUNG_2 = 251011;
     ...
     public static final int MENU_BANH_TET = 251012;

    public static final int MENU_BANH_TET_2 = 251013;

    public static final int MENU_BANH_CHUNG = 251014;

    public static final int MENU_BANH_CHUNG_2 = 251015;
    
    public static final int MENU_THOI_VANG = 251016;
    
    public static final int MENU_OPTION_USE_ITEM1467 = 1467;
    public static final int MENU_OPTION_USE_ITEM1468= 1468;
    public static final int MENU_OPTION_USE_ITEM1469 = 1469;
    public static final int CONFIRM_BUY_INSPECT_ITEM = 5000;
...
//                } else {
//                    text.append("\n|7|- NHÀ CÁI ĐANG BẢO TRÌ -\n|3|Kết quả vẫn sẽ được trao nếu bạn đã đặt cược\n\n|7|Thời gian còn lại: ").append(Util.msToTimeNdung(TaiXiu.gI().lastTimeEnd + TaiXiu.TIME_END)).append("\n\n|7|Hệ thống sắp bảo trì");
//                }
//            }
//            case TAI_XIU_TAI ->
//                text.append("\n|7|- Mini Game -").append(!TaiXiu.gI().listKetQua.isEmpty() ? "\n|3|Kết quả kì trước:  " + TaiXiu.gI().getKetQua() : "").append(pl.isAdmin() ? "\n\n|7|Admin [" + pl.name + "] Đã can thiệp kết quả: " + TaiXiu.gI().getCau() : "").append("\n\n|2|Cửa Tài (").append(TaiXiu.gI().playersTai.size()).append(" người - bạn đặt ").append(Util.numberToMoney(pl.goldTai)).append(" Vàng - tổng ").append(Util.numberToMoney(TaiXiu.gI().totalTai)).append(" Vàng)\n" + "Cửa Xỉu  (").append(TaiXiu.gI().playersXiu.size()).append(" người - bạn đặt ").append(Util.numberToMoney(pl.goldXiu)).append(" Vàng - tổng ").append(Util.numberToMoney(TaiXiu.gI().totalXiu)).append(" Vàng)\n\n|7|Thời gian còn lại: ").append(Util.msToTimeNdung(TaiXiu.gI().lastTimeEnd + TaiXiu.TIME_END)).append("\n|3|Bạn đã cược Tài : ").append(Util.numberToMoney(pl.goldTai)).append(" Vàng");
//            case TAI_XIU_XIU ->
//                text.append("\n|7|- Mini Game -").append(!TaiXiu.gI().listKetQua.isEmpty() ? "\n|3|Kết quả kì trước:  " + TaiXiu.gI().getKetQua() : "").append(pl.isAdmin() ? "\n\n|7|Admin [" + pl.name + "] Đã can thiệp kết quả: " + TaiXiu.gI().getCau() : "").append("\n\n|2|Cửa Tài (").append(TaiXiu.gI().playersTai.size()).append(" người - bạn đặt ").append(Util.numberToMoney(pl.goldTai)).append(" Vàng - tổng ").append(Util.numberToMoney(TaiXiu.gI().totalTai)).append(" Vàng)\n" + "Cửa Xỉu (").append(TaiXiu.gI().playersXiu.size()).append(" người - bạn đặt ").append(Util.numberToMoney(pl.goldXiu)).append(" Vàng - tổng ").append(Util.numberToMoney(TaiXiu.gI().totalXiu)).append(" Vàng)\n\n|7|Thời gian còn lại: ").append(Util.msToTimeNdung(TaiXiu.gI().lastTimeEnd + TaiXiu.TIME_END)).append("\n|3|Bạn đã cược Xỉu : ").append(Util.numberToMoney(pl.goldXiu)).append(" Vàng");
//            case TAI_XIU_EMPTY ->
//                text.append("\n|7|- Mini Game -").append(!TaiXiu.gI().listKetQua.isEmpty() ? "\n|3|Kết quả kì trước:  " + TaiXiu.gI().getKetQua() : "").append(pl.isAdmin() ? "\n\n|7|Admin [" + pl.name + "] Đã can thiệp kết quả: " + TaiXiu.gI().getCau() : "").append("\n\n|2|Cửa Tài (").append(TaiXiu.gI().playersTai.size()).append(" người - bạn đặt ").append(Util.numberToMoney(pl.goldTai)).append(" Vàng - tổng ").append(Util.numberToMoney(TaiXiu.gI().totalTai)).append(" Vàng)\n" + "Cửa Xỉu (").append(TaiXiu.gI().playersXiu.size()).append(" người - bạn đặt ").append(Util.numberToMoney(pl.goldXiu)).append(" Vàng - tổng ").append(Util.numberToMoney(TaiXiu.gI().totalXiu)).append(" Vàng)\n\n|7|Thời gian còn lại: ").append(Util.msToTimeNdung(TaiXiu.gI().lastTimeEnd + TaiXiu.TIME_END));
//            
            
            case TAI_XIU_HD ->
                text.append("|5|Con Số May Mắn là trò chơi dự đoán số ngẫu nhiên từ 1 đến 999.\n\n")
                        .append("|6|Cứ mỗi 300 giây, hệ thống sẽ tự động quay ra một con số ngẫu nhiên.\n\n")
                        .append("|7|Người chơi có thể đăng ký nhiều con số bằng cách trả 1 Hồng Ngọc cho mỗi con số.\n\n")
                        .append("|8|Nếu bạn đoán trúng con số được quay, bạn sẽ nhận phần thưởng chia đều từ tổng số Hồng Ngọc mà tất cả người chơi đã tham gia.\n\n")
                        .append("|9|Lưu ý: Bạn có thể ghi nhiều số trong mỗi lần chơi, nhưng không được ghi trùng số đã ghi trước đó.");
        }
