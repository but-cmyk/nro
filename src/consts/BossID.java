...
public class BossID {
    ...
    public static final int DETU_BROLY = -999;
    ...
    //========================TET EVENT========================
    public static final int LAN_CON = -54745;
    public static final int TUAN_LOC = -54746;
    
    public static final int AN_TROM = -54747;
    ...
    public static final int WHIS_1 = -365;
    public static final int BERUS = -366;
    public static final int VADOS = -367;
    public static final int CHAMPA = -368;

    public static final int ANTROM = -369;
    
    public static final int CHILLER = -370;
    public static final int FROST = -371;
    public static final int CUMBER = -372;

    public static final int GOKUGOD = -373;
    public static final int BROLYSSJ = -374;
    public static final int COLLER_GOLD = -375;
    
    public static final int TAUPAYPAY = -457547;
    public static final int BE_NA = -346325;
    public static final int THO_DAI_KA = -346324;

    
         //======================RONG NHI========================

    public static final int RONG_1_SAO = -376;
    public static final int RONG_2_SAO = -377;
    public static final int RONG_3_SAO = -378;
    public static final int RONG_4_SAO = -379;
    public static final int RONG_5_SAO = -380;
    public static final int RONG_6_SAO = -381;
    public static final int RONG_7_SAO = -382;
}
