...
import static models.phoban.BlackBallWar.COST_X3;
import static models.phoban.BlackBallWar.COST_X5;
import static models.phoban.BlackBallWar.COST_X7;
import static models.phoban.BlackBallWar.X3;
import static models.phoban.BlackBallWar.X5;
import static models.phoban.BlackBallWar.X7;
    ...
    public void xHPKI(Player player, byte x) {
        ...
        if (player.inventory.gem >= cost) {
            ...
            Service.gI().sendThongBao(player, "Không đủ ngọc để thực hiện, còn thiếu "
                    + Util.powerToString(cost - player.inventory.gem) + " ngọc");
        }
    }
