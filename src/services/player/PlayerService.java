            ...
            if (Util.canDoWithTime(player.lastTimeRevived, 1500)) {
                ...
                if (MapService.gI().isMapBlackBallWar(player.zone.map.mapId)) {
                    if (player.inventory.gold >= COST_GOLD_HOI_SINH_NRSD) {
                        ...
                        Service.gI().sendThongBao(player, "Không đủ vàng để thực hiện, còn thiếu " + Util.powerToString(COST_GOLD_HOI_SINH_NRSD
                    ...
                    if (player.inventory.gem >= COST_GEM_HOI_SINH) {
                        ...
                        Service.gI().sendThongBao(player, "Không đủ ngọc để thực hiện, còn thiếu " + Util.powerToString(COST_GEM_HOI_SINH
...
//                    canHs = true;
//                } else {
//                    Service.gI().sendThongBao(player, "Không đủ vàng để thực hiện, còn thiếu " + Util.powerToString(COST_GOLD_HOI_SINH
//                            - player.inventory.gold) + " vàng");
//                    return;
//                }
//            }
