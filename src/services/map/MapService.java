...
//            }
//        } catch (Exception e) {
//            Logger.error("lỖI MAP");
//        }
//        return zoneJoin;
//    }
//
//    public Zone getZoneJoinByMapIdAndZoneId(int mapId, int zoneId) {
//        Map map = getMapById(mapId);
//        Zone zoneJoin = null;
//        try {
//            if (map != null) {
...
//        return mapId == 174 || mapId == 179 || mapId == 180 || mapId == 129 || mapId == 168;
//    }

    public boolean isMapUpDoSao(int mapId) {
