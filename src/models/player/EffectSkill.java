...
public class EffectSkill {
    ...
    public int timeSocola2;
    public int idOutfitSocola2;
    
    //Cà Rốt
    public boolean isCaRot;
    public long lastTimeCaRot;
    public int timeCaRot;
    public int idOutfitCaRot;
    ...
    public void removeSkillEffectWhenDie() {
        ...
        if (isSocola2) {
            EffectSkillService.gI().removeSocola2(this.player);
        }
        if (isLamCham) {
    ...
    if (isStun && Util.canDoWithTime(lastTimeStartStun, timeStun)) {
      ...
      if (isSocola2 && Util.canDoWithTime(lastTimeSocola2, timeSocola2)) {
        EffectSkillService.gI().removeSocola2(this.player);
    }
