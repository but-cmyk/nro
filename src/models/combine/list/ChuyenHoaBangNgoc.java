    ...
    public static void showInfoCombine(Player player) {
        if (player.combineNew.itemsCombine.size() == 2) {
            ...
            if (khongthechuyenhoa == 1) {
                ...
                Service.gI().sendThongBaoOK(player, "Trang bị chuyển hóa phải chưa nâng cấp và pha lê hóa");
                return;
            ...
            NpcSay.append("|2|Cần 2000 ngọc");

            CombineService.gI().baHatMit.createOtherMenu(player, ConstNpc.MENU_START_COMBINE, NpcSay.toString(),
                    "Nâng cấp\n2000\nngọc", "Từ chối");
        } else {
            Service.gI().sendThongBaoOK(player, "Cần 1 trang bị có cấp từ [+4] và 1 trang bị không cấp nhưng cao hơn 1 bậc");
        }
    }
