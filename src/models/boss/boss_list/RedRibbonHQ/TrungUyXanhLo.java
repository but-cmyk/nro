...
//            it = new ItemMap(this.zone, 77, Util.nextInt(10, 30), this.location.x, this.zone.map.yPhysicInTop(this.location.x,
//                    this.location.y - 24), plKill.id);
//            Service.gI().dropItemMap(this.zone, it);
//        }
//    }
@Override
    public void reward(Player plKill) {
       // if (Util.isTrue(100, 100)) {
            // Drop item 611 cố định
            ItemMap it = new ItemMap(this.zone, 611, 1, this.location.x,
                    this.zone.map.yPhysicInTop(this.location.x, this.location.y - 24), plKill.id);
            Service.gI().dropItemMap(this.zone, it);

            // Drop item ngẫu nhiên từ 17 đến 20, số lượng là 1
            int randomItemId = Util.nextInt(17, 20); // random từ 17 đến 20
            it = new ItemMap(this.zone, randomItemId, 1, this.location.x,
                    this.zone.map.yPhysicInTop(this.location.x, this.location.y - 24), plKill.id);
            Service.gI().dropItemMap(this.zone, it);
       // }
    }
    ...
    @Override
    public void joinMap() {
        ChangeMapService.gI().changeMap(this, this.zone, 1145, this.zone.map.yPhysicInTop(1145, 0));
