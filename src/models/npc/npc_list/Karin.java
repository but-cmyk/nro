                                    ...
                                    switch (player.playerTask.taskMain.id) {
                                        case 10 -> {
                                            if (player.playerTask.taskMain.index == 1) {
                                                TaskService.gI().doneTask(player, ConstTask.TASK_10_0);
                                                TaskService.gI().doneTask(player, ConstTask.TASK_10_1);
                                                TaskService.gI().doneTask(player, ConstTask.TASK_10_2);
                                                TaskService.gI().doneTask(player, ConstTask.TASK_10_3);
