                ...
                case 129 -> {
                    ...
                    if (pl.levelWoodChest == 0) {
                        menuSelect = new String[]{
                            "Hướng\ndẫn\nthêm",
                            "Thi đấu\n" + Util.powerToString(pl.rubyChallenge) + " ngọc",
                            "Thi đấu\n" + Util.powerToString(pl.goldChallenge) + " vàng",
                            "Về\nĐại Hội\nVõ Thuật"
                        };
                    } else {
                        menuSelect = new String[]{
        ...
        if (useRuby) {
            if (player.inventory.gem >= rubyChallenge) {
                ...
                Service.gI().sendThongBao(player,
                    "Bạn không đủ ngọc, còn thiếu " + Util.powerToString(rubyChallenge - player.inventory.gem) + " ngọc nữa");
            }
        } else {
            if (player.inventory.gold >= goldChallenge) {
                ...
                Service.gI().sendThongBao(player,
                    "Bạn không đủ vàng, còn thiếu " + Util.powerToString(goldChallenge - player.inventory.gold) + " vàng nữa");
            }
        }
    }
