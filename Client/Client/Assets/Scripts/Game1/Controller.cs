namespace Game1
{
    ...
    public class Controller : IMessageHandler
    {
                    ...
                    case -67:
                        {
                            ...
                            try
                            {
                                ...
                                if (num168 >= 0)
                                {
                                    ...
                                    {
                                        SmallImage.imgNew = new Small[(SmallImage.maxSmall > 0) ? SmallImage.maxSmall : 1000];
                                    }
                                    if (num168 >= SmallImage.imgNew.Length)
                                    {
                                        Small[] newArr = new Small[num168 + 100];
                                        Array.Copy(SmallImage.imgNew, newArr, SmallImage.imgNew.Length);
                                        SmallImage.imgNew = newArr;
                                    }
                                    Image iconImg = (array17 != null && array17.Length >= 8) ? createImage(array17) : null;
                                    if (iconImg != null && iconImg.texture != null)
                                    {
                                        if (SmallImage.imgNew[num168] == null)
                                        {
                                            SmallImage.imgNew[num168] = new Small(iconImg, num168);
                                        }
                                        else
                                        {
                                            SmallImage.imgNew[num168].img = iconImg;
                                        }
                                    ...
                                    else
                                    {
                                        if (SmallImage.imgNew[num168] == null)
                                        {
                                            SmallImage.imgNew[num168] = new Small(SmallImage.imgEmpty, num168);
                                        }
                                        else
                                        {
                                            SmallImage.imgNew[num168].img = SmallImage.imgEmpty;
                                        }
                                    }
                                }
                            }
                            ...
                            {
                                Cout.LogError("Loi case -67: " + exIcon.ToString());
                            }
                            break;
                        }
                    case -66:
                        {
                            try
                            {
                                ...
                                {
                                    NinjaUtil.readByteArray(msg);
                                }
                            }
                            catch (Exception exEff)
                            {
                                Cout.LogError("Loi case -66: " + exEff.ToString());
                            }
                            break;
                        }
                    case -32:
                    ...
                    case 54:
                        {
                            ...
                            SkillPaint sp54 = null;
                            if (GameScr.sks != null && num17 >= 0 && num17 < GameScr.sks.Length)
                            {
                                sp54 = GameScr.sks[num17];
                            }
                            if (sp54 == null && GameScr.sks != null && GameScr.sks.Length > 0)
                            {
                                sp54 = GameScr.sks[0];
                            }
                            if ((TileMap.tileTypeAtPixel(@char.cx, @char.cy) & 2) == 2)
                            {
                                @char.setSkillPaint(sp54, 0);
                            }
                            else
                            {
                                @char.setSkillPaint(sp54, 1);
                            }
        ...
        private void createMap(myReader d)
        {
            ...
            int npcLen = d.readUnsignedByte();
            Npc.arrNpcTemplate = new NpcTemplate[System.Math.Max(256, npcLen)];
            for (int b = 0; b < npcLen; b++)
            {
                Npc.arrNpcTemplate[b] = new NpcTemplate();
                Npc.arrNpcTemplate[b].npcTemplateId = (sbyte)b;
                ...
                int menuLen = d.readByte();
                if (menuLen > 0)
                {
                    Npc.arrNpcTemplate[b].menu = new string[menuLen][];
                    for (int j = 0; j < menuLen; j++)
                    {
                        int subMenuLen = d.readByte();
                        Npc.arrNpcTemplate[b].menu[j] = new string[subMenuLen];
                        for (int k = 0; k < subMenuLen; k++)
                        {
            ...
            int mobLen = d.readUnsignedByte();
            Mob.arrMobTemplate = new MobTemplate[System.Math.Max(256, mobLen)];
            for (int b2 = 0; b2 < mobLen; b2++)
            {
        ...
        public void readClanMsg(Message msg, int index)
        {
            ...
            {
                Cout.println("LOI TAI CMD -= " + msg.command + " | " + ex.Message);
                Debug.LogError($"[Controller] LOI TAI CMD={msg.command}: {ex.Message}\n{ex.StackTrace}");
            }
        }
        ...
        public void loadInfoMap(Message msg)
        {
            try
            {
                ...
                for (sbyte b = 0; b < num; b++)
                {
                    ...
                    MobTemplate mobT = mob.getTemplate();
                    if (mobT != null && mobT.type != 0)
                    {
                        if (b % 3 == 0)
                        {
                            mob.dir = -1;
            ...
            {
                Res.err(">>>>>>>>>>>>>>>>>>>>>>>>>>>>>>> Loadmap khong thanh cong: " + ex.ToString());
                Debug.LogException(ex);
                try
                {
                    System.IO.File.AppendAllText("game_error.log", "\n[" + DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss") + "] " + ex.ToString() + "\n");
                }
                catch (Exception) {}
                Char.isLoadingMap = false;
                LoginScr.isContinueToLogin = false;
                ...
                GameCanvas.startOKDlg("Lỗi tải bản đồ, vui lòng thử lại");
                return;
            }
            GameCanvas.isLoading = false;
                    ...
                    case 4:
                        {
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    {
                                        throw new Exception("ItemTemplates is empty after RMS load");
                                    }
                            ...
                            if (GameScr.vsData == GameScr.vcData && GameScr.vsMap == GameScr.vcMap && GameScr.vsSkill == GameScr.vcSkill && GameScr.vsItem == GameScr.vcItem)
                            {
                                ...
                                {
                                    Cout.LogError("Loi readDart/readSkill: " + exLoadAll.ToString());
                                }
                                Service.gI().clientOk();
                            }
                            sbyte b4 = msg.reader().readByte();
        ...
        public void messageNotLogin(Message msg)
        {
            try
            {
                ...
                // Removed faulty skip of ServerListScreen (loadScreen = true) that broke data downloading
            }
            catch (Exception)
            {
            }
                    ...
                    case 0:
                        {
                            ...
                            try
                            {
                                ...
                                for (int k = 0; k < Char.myCharz().arrItemBody.Length; k++)
                                {
                                    ...
                                    {
                                        itemTemplate = new ItemTemplate(num6, 0, 0, "Item " + num6, "", 0, 0, 0, 0, false);
                                    }
                            ...
                            try
                            {
                                ...
                                for (int m = 0; m < Char.myCharz().arrItemBag.Length; m++)
                                {
                                    ...
                                    ItemTemplate itemBagTemplate = ItemTemplates.get(num10);
                                    if (itemBagTemplate == null)
                                    {
                                        itemBagTemplate = new ItemTemplate(num10, 0, 0, "Item " + num10, "", 0, 0, 0, 0, false);
                                    }
                                    Char.myCharz().arrItemBag[m] = new Item();
                                    Char.myCharz().arrItemBag[m].template = itemBagTemplate;
                            ...
                            {
                                Cout.println("Error load arrItemBag: " + exBag.ToString());
                            }
                            try
                            {
                                ...
                                for (int num12 = 0; num12 < Char.myCharz().arrItemBox.Length; num12++)
                                {
                                    ...
                                    ItemTemplate itemBoxTemplate = ItemTemplates.get(num13);
                                    if (itemBoxTemplate == null)
                                    {
                                        itemBoxTemplate = new ItemTemplate(num13, 0, 0, "Item " + num13, "", 0, 0, 0, 0, false);
                                    }
                                    Char.myCharz().arrItemBox[num12] = new Item();
                                    Char.myCharz().arrItemBox[num12].template = itemBoxTemplate;
                            ...
                            {
                                Cout.println("Error load arrItemBox: " + exBox.ToString());
                            }
                            Char.myCharz().statusMe = 4;
