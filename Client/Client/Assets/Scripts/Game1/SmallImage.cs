namespace Game1
{
    ...
    public class SmallImage
    {
    	...
    	public static void createImage(int id)
    	{
    		...
    		if (imgNew == null)
    		{
    			imgNew = new Small[(maxSmall > 0) ? maxSmall : 1000];
    		}
    		if (id >= imgNew.Length)
    		{
    			Small[] array0 = new Small[id + 100];
    			Array.Copy(imgNew, array0, imgNew.Length);
    			imgNew = array0;
    		}
    		...
    		if (array != null && array.Length >= 8)
    		{
    			...
    			if (!flag)
    			{
    				...
    				if (image3 != null && image3.texture != null && image3.w > 1 && image3.h > 1)
    				{
    				...
    				{
    					flag = true;
    					Rms.DeleteStorage(mGraphics.zoomLevel + "Small" + id);
    				}
    			}
    		}
    		else
    	...
    	public static void drawSmallImage(mGraphics g, int id, int f, int x, int y, int w, int h, int transform, int anchor)
    	{
    		...
    		if (imgbig == null)
    		{
    			...
    			{
    				if (small.img != null && small.img.texture != null)
    				{
    		...
    		else if (smallImg != null)
    		{
    			...
    			else if (smallImg[id][0] != 4 && smallImg[id][0] >= 0 && smallImg[id][0] < imgbig.Length && imgbig[smallImg[id][0]] != null)
    			{
