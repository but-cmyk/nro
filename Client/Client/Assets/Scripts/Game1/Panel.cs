namespace Game1
{
    ...
    public class Panel : IActionListener, IChatable
    {
        ...
        private static int[][] a_id = new int[][]
      {
        ...
        public void RegisterSubPanel(int panelType, ISubPanel subPanel)
        {
            if (subPanel != null)
            {
                subPanel.Init(this);
                subPanels[panelType] = subPanel;
            }
        }

        public ISubPanel GetCurrentSubPanel()
        {
            if (subPanels.TryGetValue(type, out ISubPanel subPanel))
            {
                return subPanel;
            }
            return null;
        ...
        public void addItemDetail(Item item)
        {
            try
            {
                ...
                if (item.itemOption != null)
                {
                    ...
                    {
                        if (item.itemOption[i] == null || item.itemOption[i].optionTemplate == null) continue;
                ...
                if (item.itemOption != null)
                {
                    ...
                    {
                        if (item.itemOption[j] == null || item.itemOption[j].optionTemplate == null) continue;
                ...
                if (item.itemOption != null)
                {
                    ...
                    {
                        if (item.itemOption[k] == null || item.itemOption[k].optionTemplate == null) continue;
                        if (item.itemOption[k].optionTemplate.name != null && item.itemOption[k].optionTemplate.name.StartsWith("$") ? true : false)
                        {
        ...
        {
            ISubPanel activeSubPanel = GetCurrentSubPanel();
            if (activeSubPanel != null && activeSubPanel.UpdateKey())
            {
                return;
            }
        ...
        {
            if (Char.myCharz().arrItemBody == null || Char.myCharz().arrItemBag == null)
            {
                return;
            }
            if (isnewInventory)
        ...
        public void paint(mGraphics g)
        {
            ...
            paintTab(g);
            ISubPanel activeSubPanel = GetCurrentSubPanel();
            bool subPanelHandled = false;
            if (activeSubPanel != null)
            {
                subPanelHandled = activeSubPanel.Paint(g, X, Y, W, H);
            }
            if (!subPanelHandled)
            {
                switch (type)
            ...
            for (int i = 0; i < arrItemBody.Length + arrPetSkill.Length; i++)
            {
                ...
                else if (!flag)
                {
                    ...
                    else
                    {
                        ...
                        if (GameScr.efs != null && GameScr.efs.Length > 98 && GameScr.efs[98] != null && GameScr.efs[98].arrEfInfo != null && GameScr.efs[98].arrEfInfo.Length > 0)
                        {
        ...
        public void paintBox(mGraphics g)
        {
            g.setColor(16711680);
            g.setClip(xScroll, yScroll, wScroll, hScroll);
            g.translate(0, -cmy);
            try
            {
                ...
                for (int i = 0; i < currentListLength; i++)
                {
                    ...
                    if (item.itemOption != null)
                    {
                        ...
                        {
                            if (item.itemOption[l] == null || item.itemOption[l].optionTemplate == null) continue;
                    ...
                    if (item.itemOption != null)
                    {
                        ...
                        {
                            if (item.itemOption[num10] != null && item.itemOption[num10].optionTemplate != null)
        ...
        public void paintCombine(mGraphics g)
        {
            g.setColor(16711680);
            g.setClip(xScroll, yScroll, wScroll, hScroll);
            g.translate(0, -cmy);
            ...
            for (int j = 0; j < vItemCombine.size() + 1; j++)
            {
                ...
                if (item.itemOption != null)
                {
                    ...
                    {
                        if (item.itemOption[num9] != null && item.itemOption[num9].optionTemplate != null)
        ...
        public void paintInventory(mGraphics g)
        {
            ...
            for (int num22 = 1; num22 < currentListLength; num22++)
            {
                try
                {
                    ...
                    {
                        if (arrItemBody2 != null && inventorySelect_body >= 0 && inventorySelect_body < arrItemBody2.Length)
                        {
                            item3 = arrItemBody2[inventorySelect_body];
                        }
                    }
                    else
                    {
                        if (arrItemBag2 != null && inventorySelect_bag >= 0 && inventorySelect_bag < arrItemBag2.Length)
                        {
                            item3 = arrItemBag2[inventorySelect_bag];
                        }
                    }
                    if (item3 != null && item3.itemOption != null)
                    {
                        for (int num30 = 0; num30 < item3.itemOption.Length; num30++)
                        {
                            if (item3.itemOption[num30] != null && item3.itemOption[num30].optionTemplate != null
                                && item3.itemOption[num30].optionTemplate.id == 72 && item3.itemOption[num30].param > 0)
                            {
                    ...
                    if (item3.itemOption != null)
                    {
                        ...
                        {
                            if (item3.itemOption[num31] == null || item3.itemOption[num31].optionTemplate == null)
                            {
                                continue;
                            }
                    ...
                    if (item3.itemOption != null)
                    {
                        ...
                        {
                            if (item3.itemOption[num33] != null && item3.itemOption[num33].optionTemplate != null)
                            {
                        ...
                        {
                            if (item3.itemOption[num34] != null && item3.itemOption[num34].optionTemplate != null)
                            {
