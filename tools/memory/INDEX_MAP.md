...
| **Hệ thống Boss & Event** | `src/boss/Boss.java`, `src/boss/BossManager.java` | `Boss.update()`, `Boss.leaveMap()`, `reward()` | [src/boss/GEMINI.md](file:///d:/SRC_NRO_219/SRC_NRO_219/SRC_NRO_189/SRC_NRO_OK/SRC_NRO_OK/DEMO_NETBEAN_tsSv2_new/src/boss/GEMINI.md) |
